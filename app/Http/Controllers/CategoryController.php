...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('icon')){
            ...
            ImageOptimizer::optimize(base_path('public/').$category->icon);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->swapOrder(Category::class,$category->orders,$request->orders);
    ...
    public function enableCategory($id){
        ...
        $categories = $category->is_enable == 1 ? 0 : 1;

        $category->is_enable = $categories;
        $category->save();
