...
$(".js_category_filter").click(function (e) {
    e.preventDefault();
    var val = $(this).attr('category_val');
    $('input[name=category_id]').val(val);
    filter();
});

$(".js_subsubcategory_filter").click(function (e) {
    e.preventDefault();
    var val = $(this).attr('subsubcategory_val');
    $('input[name=subsubcategory_id]').val(val);
    filter();
});

$(".js_brand_filter").click(function (e) {
    e.preventDefault();
    var val = $(this).attr('brand_val');
    $('input[name=brand_id]').val(val);
    filter();
});

$(".js_sort_filter").click(function (e) {
    e.preventDefault();
    var val = $(this).attr('sort_val');
