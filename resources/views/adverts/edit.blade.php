...
@section('content')
<form class="form-horizontal" action="{{ route('adverts.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-pencil"></i> {{__('Edit Advertise Banner Information')}}</h3>
        </div>
        <!--Horizontal Form-->
        <!--===================================================-->
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="{{__('Name')}}" id="name" name="name" value="{{ $banner->name }}" class="form-control" >
                        @if ($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="{{__('Arabic Name')}}" id="ar_name" name="ar_name" value="{{ $banner->ar_name }}" class="form-control" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="{{__('Description')}}" id="description" name="description" value="{{ $banner->description }}" class="form-control" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" placeholder="{{__('Arabic Description')}}" id="ar_description" name="ar_description" value="{{ $banner->ar_description }}" class="form-control" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="file" placeholder="{{__('Banner')}}" id="banner" name="banner" value="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <img src="{{ asset($banner->banner) }}" width="100%">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select name="status" class="form-control">
                            <option value="deactive" <?php if($banner->status == 'deactive') { echo "selected"; } ?>>{{__('Deactive')}}</option>
                            <option value="active" <?php if($banner->status == 'active') { echo "selected"; } ?>>{{__('Active')}}</option>
                        </select>
                    ...
                    <div class="col-sm-10">
                        <div id="demo-dp-range">
                            <div class="input-daterange input-group" id="datepicker">
                                <input type="text" name="start_date" placeholder="{{__('Start Date')}}" value="{{ $banner->start_time }}" class="form-control" >
                                <span class="input-group-addon">{{__('To')}}</span>
                                <input type="text" name="end_date" placeholder="{{__('Expire Date')}}" value="{{ $banner->end_time }}" class="form-control" >
                            </div>
                        </div>
                    ...
                    <div class="col-sm-10">
                        ...
                        <select name="product_cat" class="form-control">
                            @foreach($product_cat as $product)
                                <option value="{{ $product->id }}" <?php if($product->id == $banner->product_category) { echo "selected"; } ?>>{{ $product->name }}</option>
                            @endforeach
                        </select>
                        @endif
                    ...
                    <div class="col-sm-10">
                        ...
                        <select name="banner_cat" class="form-control">
                            @foreach($banner_cat as $banner_cat)
                                <option value="{{ $banner_cat->id }}" <?php if($banner_cat->id == $banner->banner_category) { echo "selected"; } ?>>{{ $banner_cat->name }}</option>
                            @endforeach
                        </select>
                        @endif
