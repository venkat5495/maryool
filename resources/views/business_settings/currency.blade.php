...
<div class="container-fluid">    
    <div class="row header">
        <div class="col-lg-10">
            <h1>Home Default Currency</h1>
            <ul class="breadcrumb">
                <li>{{__('Home')}}</li>
                <li><a href="#">{{__('Home Default Currency')}}</a></li>
            </ul>
        </div>
    </div>
    <hr>
...
<div class="row">
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> {{__('Home Default Currency')}}</h3>
            </div>
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> {{__('System Default Currency')}}</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    @csrf
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-pencil"></i> {{__('Set Currency Formats')}}</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('business_settings.update') }}" method="POST">
                    @csrf
                ...
                <tbody>
                    @for($i = 0; $i < count($currencies)-1; $i++)
                        <tr>
                            ...
                            <td><button class="btn btn-primary" type="submit" onclick="updateCurrency({{ $currencies[$i]->id }})" data-toggle="tooltip" title="Save"><i class="fa fa-save"></i></button></td>
                        </tr>
                    @endfor
                    <tr>
                        ...
                        <td><button class="btn btn-primary" type="submit" onclick="updateYourCurrency({{ $currencies[count($currencies)-1]->id }})"  data-toggle="tooltip" title="Save"><i class="fa fa-save"></i></button></td>
                    </tr>
                </tbody>
            </table>
