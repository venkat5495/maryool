...
<footer class="footer_dark">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="widget">
                        ...
                        <ul class="widget_instafeed instafeed_col4">
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/furniture_insta_small1.jpg')}}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/furniture_insta_small2.jpg')}}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/furniture_insta_small3.jpg')}}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/furniture_insta_small4.jpg')}}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/furniture_insta_small5.jpg')}}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/furniture_insta_small6.jpg')}}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/furniture_insta_small7.jpg')}}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/furniture_insta_small8.jpg')}}" alt="insta_img"><span class="insta_icon"><i class="ti-instagram"></i></span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="bottom_footer bg_dark4">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="mb-md-0 text-center text-md-left">Copyright &copy; 2020 <a href="#">Maryool</a> .All Right Reserved.</p>
                </div>
                <div class="col-md-6">
